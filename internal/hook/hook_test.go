...
func TestReadRealPayload(t *testing.T) {
	req, err := hook.Read(strings.NewReader(`{
      ...
      "cwd": "/Users/p/Workspace/insurance-mono",
	...
	require.Equal(t, "/Users/p/Workspace/insurance-mono", req.Cwd)
...
func TestDecide(t *testing.T) {
	...
	require.NoError(t, os.WriteFile(filepath.Join(repo, ".git", "HEAD"), []byte("ref: refs/heads/ins-1\n"), 0o644))
