...
func TestMatchBashOnFeatureBranch(t *testing.T) {
	tests := []struct {
		...
		{name: "git checkout", command: "git checkout -b topic-1 master"},
		...
		{name: "git push feature branch", command: "git push -u origin feature-branch"},
		{name: "git push force with lease", command: "git push --force-with-lease origin feature-branch"},
		...
		{name: "git push force", command: "git push --force origin feature-branch", rule: "git-push-force"},
		{name: "git push short force", command: "git push -f origin feature-branch", rule: "git-push-force"},
		...
		{name: "git branch force delete", command: "git branch -D topic-1", rule: "git-branch-delete"},
...
func TestMatchWorktree(t *testing.T) {
	...
	writeHead(t, gitDir, "feature-branch")
